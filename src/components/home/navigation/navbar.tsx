        ...
        {isOpen && (
          <div className="md:hidden absolute top-14 left-0 w-full bg-background/90 backdrop-blur-md shadow-lg z-40">
            <ul className="flex flex-col items-center gap-4 py-4">
              <li><Link href="/" className="hover:text-foreground/80 text-sm uppercase text-neutral-100">Home</Link></li>
              <li><Link href="/services" className="hover:text-foreground/80 text-sm uppercase text-neutral-100">Services</Link></li>
              <li><Link href="/services/immigration" className="text-sm text-neutral-300">Immigration Law</Link></li>
              <li><Link href="/services/estate-planning" className="text-sm text-neutral-300">Estate Planning</Link></li>
              <li><Link href="/services/citizenship" className="text-sm text-neutral-300">Citizenship & Visas</Link></li>
              <li><Link href="#" className="hover:text-foreground/80 text-sm uppercase text-neutral-100">About</Link></li>
